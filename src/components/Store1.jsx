    ...
    return (
      ...
      >
        ...
        <div className="flex-1 flex flex-col items-start justify-start py-5 pl-0 pr-[215px] box-border gap-6 min-w-[263px] max-w-full mq450:pr-5 mq450:box-border">
          <h1
            className="m-0 relative text-inherit leading-[40px] font-normal font-inherit mq450:text-3xl mq450:leading-[24px] mq825:text-10xl mq825:leading-[32px]"
            style={hamburg1Style}
          >
            {hamburg}
          </h1>
