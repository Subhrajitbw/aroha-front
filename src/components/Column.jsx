...
const Column = memo(({ className = "", localStores, seeAll }) => {
  return (
    <div
    ...
    >
      <h1 className="m-0 relative text-inherit leading-[40px] font-normal font-inherit mq800:text-10xl mq800:leading-[32px] mq450:text-3xl mq450:leading-[24px]">
        {localStores}
      </h1>
