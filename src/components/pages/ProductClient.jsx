  ...
  return (
    <div className="min-h-screen text-stone-900 font-sans">
      <main className="min-h-screen max-w-[1920px] mx-auto flex flex-col lg:flex-row">
        {/* LEFT: IMAGE GALLERY */}
        <div className="w-full lg:w-7/12 relative flex flex-col items-center justify-center pt-6 sm:pt-8 lg:pt-0 px-0 lg:px-12 xl:px-24 min-h-[50vh] lg:h-screen lg:sticky lg:top-0 bg-white">
